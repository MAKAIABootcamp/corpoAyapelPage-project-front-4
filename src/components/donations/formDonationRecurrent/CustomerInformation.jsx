...
// const CustomerInformation = ({  selectedAmount, dataFormDonationRecurrent, setDataFormDonationRecurrent }) => {
...
//   // useEffect(() => {
//   //   console.log('El estado de suscriptionDonation ha cambiado:', suscriptionDonation);
//   //   fetchClientIP();
//   // }, [suscriptionDonation]);
...
//     if (Object.keys(dataFormDonationRecurrent.email).length > 0) {
//       const customerResponse = await createNewCustomer(dataFormDonationRecurrent);
//       customerUpdated = {
//         ...suscriptionDonation,
//         ...customerResponse,
//       }
