...
function HowToHelp({
    ...
    client
      .fetch(
        `*[_type == "paginas" && titulo == "Como Ayudar"] {
          titulo,
          "subcontent": subcontent[].asset->url,
          "fondos": fondos[].asset->url
        }`
      )
  ...
  return (
    <div className="toHelp">
      <div
        className="toHelp__Banner sec"
        style={{ backgroundImage: `url('${mapBackGround[0]?.fondos[0]}')`}}
      >
        <div className="toHelp__Content">
          ...
          <div className="miniCarrousel">
            <MiniCarrousel
              indice={0}
              // style={{ backgroundImage: `url('${mapBackGround[0]?.subcontent[0]}')`}}
              // cambiarImagen={cambiarImagen1}
              imagenActual={mapBackGround[0]?.subcontent[0]}
            ...
            <MiniCarrousel
              ...
              imagenActual={mapBackGround[0]?.subcontent[1]}
      ...
      <div className="formulario">
        <HubspotProvider>
          <div
            ...
            id="voluntarios"
            style={{ backgroundImage: `url('${mapBackGround[0]?.fondos[1]}')`}}
          >
            <ToHelpForm
              titulo="Voluntarios"
              direccion="normal"
              ...
              list={[]}
              imgURL={mapBackGround[0]?.subcontent[2]}
            />
          </div>
          <div
            className="formulario__empresas sec"
            id="empresas"
            style={{ backgroundImage: `url('${mapBackGround[0]?.fondos[2]}')`}}
          >
            <ToHelpForm
              titulo="Empresas"
              direccion="reverse"
              ...
              imgURL={mapBackGround[0]?.subcontent[3]}
            />
          </div>
        </HubspotProvider>
      </div>
